...
OFFICIAL_CATEGORY_SOURCE_MAP = {
    ...
    # Expanded Financial Keywords (80+ categories)
    "accountants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "accounting-services": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "accounting-firms": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "accounting-software-services": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "tax-practitioners": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "tax-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "tax-advocates": ["ICAI", "BAR_COUNCIL", "YELLOWPAGES", "SITEMAP"],
    "taxation-services": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "tax-filing-services": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "gst-consultants": ["GST", "YELLOWPAGES", "ASKLAILA", "JUSTDIAL", "GROTAL"],
    "gst-return-filing": ["GST", "YELLOWPAGES", "ASKLAILA", "JUSTDIAL"],
    "gst-registration-services": ["GST", "YELLOWPAGES", "ASKLAILA", "JUSTDIAL"],
    "gst-suvidha-providers": ["GST", "YELLOWPAGES", "JUSTDIAL"],
    "income-tax-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "income-tax-return-services": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "tds-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "professional-tax-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "bookkeeping-services": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "payroll-services": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "payroll-processing-services": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "audit-firms": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "audit-assurance-services": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "internal-auditors": ["ICAI", "YELLOWPAGES", "JUSTDIAL"],
    "forensic-audit-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL"],
    "ca-office": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "virtual-accountants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "lic-agents": ["IRDAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "insurance-consultancy": ["IRDAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "mutual-fund-advisors": ["AMFI", "SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "mutual-fund-distributors": ["AMFI", "SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "financial-advisors": ["AMFI", "SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "financial-planning-services": ["AMFI", "SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "investment-advisory-services": ["SEBI", "AMFI", "YELLOWPAGES", "JUSTDIAL", "GROTAL"],
    "wealth-management-advisors": ["SEBI", "AMFI", "YELLOWPAGES", "JUSTDIAL", "GROTAL"],
    "share-market-advisors": ["SEBI", "NSE", "BSE", "YELLOWPAGES", "JUSTDIAL"],
    "stock-market-consultants": ["SEBI", "NSE", "BSE", "YELLOWPAGES", "JUSTDIAL"],
    "nps-consultants": ["SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL"],
    "retirement-consultants": ["SEBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL"],
    "loan-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "loan-agents": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "finance-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "business-loan-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "personal-loan-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "home-loan-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "vehicle-loan-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "micro-finance-consultants": ["RBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "banking-consultants": ["RBI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "property-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "real-estate-consultants": ["YELLOWPAGES", "ASKLAILA", "SITEMAP", "JUSTDIAL", "GROTAL"],
    "company-registration-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA", "ASKLAILA"],
    "partnership-firm-registration": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "llp-registration-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "private-limited-registration": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "society-registration-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "trust-registration-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "ngo-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "compliance-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "iso-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "tender-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "subsidy-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "government-scheme-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "project-finance-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "business-setup-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA", "SITEMAP"],
    "startup-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA", "SITEMAP"],
    "msme-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA", "SITEMAP"],
    "legal-documentation-services": ["BAR_COUNCIL", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "VYKARI"],
    "notary-services": ["BAR_COUNCIL", "YELLOWPAGES", "JUSTDIAL", "GROTAL"],
    "roc-consultants": ["ICAI", "YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "trademark-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "trademark-filing-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "copyright-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "patent-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "iec-registration-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA", "EXPORTERSINDIA"],
    "fssai-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "labour-law-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA", "VYKARI"],
    "factory-license-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "pollution-noc-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "digital-signature-providers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "pan-card-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "aadhaar-update-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "passport-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "visa-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "import-export-consultants": ["YELLOWPAGES", "EXPORTERSINDIA", "JUSTDIAL", "GROTAL", "SULEKHA", "TRADEINDIA"],
    "pf-esi-consultants": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "ASKLAILA"],
    "cyber-cafe": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "internet-cafe": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "online-service-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "e-mitra": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "csc-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "documentation-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "typing-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "photocopy-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "online-form-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "digital-services-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "e-governance-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "jan-seva-kendra": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "suvidha-kendra": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "computer-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "online-exam-centers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
    "billing-software-providers": ["YELLOWPAGES", "JUSTDIAL", "GROTAL", "SULEKHA"],
...
class ContactScraper:
    ...
    async def scrape_category_fast(self, city: str, category: str, source_name: Optional[str] = None):
        ...
        if source_name is None and normalized_category not in OFFICIAL_CATEGORY_SOURCE_MAP:
            fallback_sources = {"YELLOWPAGES", "ASKLAILA", "SITEMAP", "JUSTDIAL", "GROTAL", "SULEKHA", "TRADEINDIA", "INDIAMART", "EXPORTERSINDIA", "CLICKINDIA", "VYKARI"}
            sources = [
                s
                for s in self.scrapers + self.business_scrapers
